...
checks as the Katran smoke. Five phases: both healthy, backend 1 health endpoint
down, recovered, configured weight-zero drain, configuration rollback. Each phase sends 32 TCP and 32 UDP exchanges with distinct source
...
[Session and reload run](https://github.com/l4load/l4load/actions/runs/36129548239/job/108053397947),
2026-09-25: 320 fresh exchanges passed across five phases. Two persistent TCP
