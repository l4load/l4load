...
[Run](https://github.com/l4load/l4load/actions/runs/36252980697) · [raw artifact](https://github.com/l4load/l4load/actions/runs/36252980697/artifacts/10911010042) · [measurements](measurements.json). The artifact expires 2026-12-25; `measurements.json` records its digest and each CSV digest. The four full CSVs were downloaded and independently checked against their SHA256 hashes, sample counts and p99 values (within 0.001 µs rounding). An archival copy is retained outside this repository.
